...
for i in range(0, t.size-1):
    ...
    if y[i+1] <3 and y[i+1]>2.9:
        print(x[i]) # x = 17.277 m
        print(t[i]) # t = 1.34 s
    if y[i+1] < 0:
        break
...
#no momento de descida da bola a bola está à altura de 3m no instante 1.34s,e dista horizontalmente do ponto de lançamento aproximadamente 17,3m