...
import numpy as np
'''
Um carro elétrico de massa 2000kg sobe uma inclinação de 5º.

Determine a evolução temporal da posição e da velocidade do carro, se o
carro produzir continuamente a potência 40kW, e partir de uma velocidade de 1m/s.
