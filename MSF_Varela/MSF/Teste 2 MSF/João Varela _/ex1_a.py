...
'''
Saca a bola do ponto (x,y,z) = (0, 3m, 0) com velocidade (vx, vy, vz) = (30m/s, 0, 0).
Considere a força de gravidade e resistência do ar.
A que distância a bola cai no solo? Faça um gráfico do movimento da bola no plano XY.
O serviço é válido, sim ou não?
'''
