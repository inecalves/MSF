...
'''
Se 50% do trabalho na descida é recuperado para carregar a bateria do
carro, qual a diferência de energia na bateria no final, depois de ter feito
a subida e a descida, comparado com no início? (Assume 100% eficiencia
do motor na subida.)

Dados: Coeficiente de resistência de rolamento µ = 0.04, coeficiente de resistência do ar Cres = 0.25, área frontal do carro A = 2m2
, densidade do ar
Par = 1.225kg/m3
