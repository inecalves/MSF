...
'''
Agora o jogafdor introduz um efeito de rotacão descrito pelo vetor ω =
(0, 0, -60rad/s). A que distância a bola cai no solo? O serviçco é vélido,
sim ou não? Considere a força de gravidade e resistência do ar e a força
de Magnus.

Considere: A bola de ténis tem raio r = 0.034m e massa m = 0.057kg. A
velocidade terminal da bola vT = 20m/s. A força de Magnus F_Magnus = 
1/2*A*Par*r*ω x v, em que A = πr2
, e Par = 1.225kg/m3
.
'''
